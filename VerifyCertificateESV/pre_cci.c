# 1 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c"
...
# 1 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c" 2
...
# 2 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c" 2
...
# 3 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c" 2
...
# 4 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c" 2

# 1 "VerifyCertificateBase64.c" 1
VerifyCertificateBase64()
{
	...
	if(strstr( lr_eval_string("{CD}"), lr_eval_string("{VerifyCertificateBase64_response}"))==0)
	{
        lr_end_transaction("VerifyCertificateBase64", 1);
		lr_error_message( lr_eval_string("error: expected contains {VerifyCertificateBase64_response}, but got {CD}"));
		return -1;
	}
	
    lr_end_transaction("VerifyCertificateBase64", 0);
	return 0;
}
# 5 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c" 2
...
# 6 "f:\\provecert\\verifycertificateesv\\\\combined_VerifyCertificateESV.c" 2
